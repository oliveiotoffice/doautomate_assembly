...
function AssemblyShaftSvg({ C, actuals, plcConnected }: { C: AssemblyTheme; actuals: Record<number, number>; plcConnected: boolean }) {
  ...
  return (
    ...
    >
      ...
      {/* ðŸ”¥ IMAGE INSIDE SVG */}
      <image
        href="/images/6630865assembly1.png"
        x="0"
        y="0"
        width="1100"
        height="300"
      ...
      />
      {/* top plug */}
      <circle cx={76} cy={62} r="18" stroke={C.svgRing} strokeWidth="4" fill="none" />
      {/* top ball */}
      <circle cx={110} cy={65} r="8" stroke={C.svgRing} strokeWidth="4" fill="none" />
      ...
      />
      {/* top plug */}
      <circle cx={1032} cy={243} r="18" stroke={C.svgRing} strokeWidth="4" fill="none" />
      {/* top ball */}
      <circle cx={1065} cy={245} r="8" stroke={C.svgRing} strokeWidth="4" fill="none" />
