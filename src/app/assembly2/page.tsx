...
const STATIONS: Station[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { name: "Plug R Force", method: "Force Sensor", required: "3.57 kN", tolerance: "Â±0.1", unit: "kN" },
      { name: "Plug R Depth", method: "Laser Distance", required: "16.10 mm", tolerance: "Â±0.05", unit: "mm" },
    ],
  },
...
const BALL_PRESS_PARAMS: Param[] = [
  { name: "Ball L Force", method: "Force Sensor", required: "4.21 kN", tolerance: "+/-0.1", unit: "kN" },
  { name: "Ball L Depth", method: "Laser Distance", required: "15.68 mm", tolerance: "+/-0.05", unit: "mm" },
  { name: "Ball R Force", method: "Force Sensor", required: "4.24 kN", tolerance: "+/-0.1", unit: "kN" },
  { name: "Ball R Depth", method: "Laser Distance", required: "15.65 mm", tolerance: "+/-0.05", unit: "mm" },
];
...
function SeqBar({
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 0, alignItems: "center", width: "100%", height: showTitle ? "calc(100% - 24px)" : "100%", minHeight: 0 }}>
  ...
  return (
    <svg
            ...
            >
              ...
              {/* ðŸ”¥ IMAGE INSIDE SVG */}
              <image
                href="/images/6630867assembly1.png"
                x="0"
                y="0"
                width="1100"
                height="300"
...
/>
              {/* top plug */}
               <circle cx={74} cy={62} r="18" stroke={C.svgRing} strokeWidth="4" fill="none" />
           {/* top ball */}
           <circle cx={108} cy={65} r="8" stroke={C.svgRing} strokeWidth="4" fill="none" />
...
/>
              {/* top plug */}
               <circle cx={1030} cy={243} r="18" stroke={C.svgRing} strokeWidth="4" fill="none" />
           {/* top ball */}
           <circle cx={1062} cy={245} r="8" stroke={C.svgRing} strokeWidth="4" fill="none" />
      ...
      />
              ...
              <line x1="220" y1="110" x2="220" y2="60" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />
   ...
   <AssemblySvgCard
      ...
      />
              ...
              <line x1="900" y1="110" x2="900" y2="60" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />
              <line x1="860" y1="115" x2="940" y2="115" stroke={C.svgLine} strokeWidth="1.5" />
      ...
      />
              ...
              <line x1="380" y1="125" x2="460" y2="125" stroke={C.svgLine} strokeWidth="2" />
 ...
 <AssemblySvgCard
      ...
      />
              ...
              {/* Right side Milling height */}
               ...
               <line x1="760" y1="125" x2="760" y2="60" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />
              <line x1="720" y1="125" x2="800" y2="125" stroke={C.svgLine} strokeWidth="2" />
     ...
     <AssemblySvgCard
      ...
      />
          ...
          {/* left side dowel length  */}
              <line x1="55" y1="125" x2="55" y2="185" stroke={C.svgLine} strokeWidth="2" />

              
          

          {/* Right side dowel length  */}
              <line x1="1050" y1="128" x2="1050" y2="185" stroke={C.svgLine} strokeWidth="2" />
    ...
    <div className="dashboard-shell assembly-dashboard" style={{ ...MONO, "--h-scale": heightScale, width: "100%", height: "100dvh", minHeight: 0, overflow: "hidden", background: C.bg, transition: "background 0.25s ease, color 0.25s ease", display: "flex", flexDirection: "column" } as CSSProperties}>
      ...
      <div className="dashboard-content" style={{ display: "flex" }}>
        ...
        <div className="dashboard-left">
          ...
          {/* Sequence 1-3 */}
          <SeqBar completedCount={completedIds.length} C={C} steps={[0, 1, 2]} showTitle border="bottom" />
